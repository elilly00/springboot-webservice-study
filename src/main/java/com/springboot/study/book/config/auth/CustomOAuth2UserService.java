...
import com.springboot.study.book.config.auth.dto.OAuthAttributes;
import com.springboot.study.book.config.auth.dto.SessionUser;
import com.springboot.study.book.domain.user.User;
import com.springboot.study.book.domain.user.UserRepository;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        String registrationId = userRequest.getClientRegistration()
                                           .getRegistrationId();
        // registrationId : 현재 로그인 중인 서비스를 구분하는 코드
